    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ${
          isActive
            ? "bg-zinc-850 text-zinc-50 shadow-sm border border-zinc-700/50"
...
export const MainLayout: React.FC = () => {
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-zinc-950 text-zinc-100 font-sans">
      {/* Sidebar */}
      <aside className="w-64 flex-shrink-0 flex flex-col border-r border-zinc-900 bg-zinc-950/80 backdrop-blur-md">
        {/* Header */}
        <div className="h-16 flex items-center px-6 border-b border-zinc-900 gap-2.5">
          ...
          <div>
            <h1 className="text-base font-semibold tracking-tight text-zinc-50 m-0">
              Repollama
            </h1>
        ...
        <div className="p-4 border-t border-zinc-900 bg-zinc-950">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-zinc-900/40 border border-zinc-800/50">
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col overflow-hidden bg-zinc-900/30">
        <header className="h-16 flex items-center justify-between px-8 border-b border-zinc-900 bg-zinc-950/20 backdrop-blur-sm">
